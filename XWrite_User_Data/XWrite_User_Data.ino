...
void setup()
{
  ...
  nano.setWritePower(2700); //9.00 dBm. Higher values may caues USB port to brown out
...
void loop()
{
  ...
  char testData[] = "|CORONA|350ml|CAD: 24/10/18|Almacen Origen: GUA|"; //You can only write even number of bytes
